...
def main() -> int:
    ...
    run_rust_contract_tests(
        ...
        expected_tests=(
            ...
            "governed_ports::governed_wire_conformance_tests::reconciliation_round_corpus_exercises_actual_ag_types_and_signature_domain",
            "governed_ports::governed_wire_conformance_tests::every_reconciliation_round_hostile_refuses_at_its_exact_boundary",
        ),
        cwd=ag_root,
        target_dir=args.ag_target_dir,
    )
    run_rust_contract_tests(
        ...
        expected_tests=(
            ...
            "governed_loop::governed_wire_conformance_tests::reconciliation_round_corpus_exercises_actual_docket_types_and_identities",
            "governed_loop::governed_wire_conformance_tests::reconciliation_round_hostiles_owned_by_docket_refuse_at_their_exact_boundary",
        ),
        cwd=docket_root,
