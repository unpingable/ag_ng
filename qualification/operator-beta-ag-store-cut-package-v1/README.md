...
Status: **CORRECTION_CANDIDATE_FOR_INDEPENDENT_REAUDIT**
...
- accepted owner gate: 7 owner cases plus 3 functional CLI cases passed; the
  functional store is seeded by a compile-time-only no-bus qualification
  fixture absent from the packaged binary;
...
and rejected package checkpoint `5c35d24a1898ae254b335b132ac7e84d831a7590`
remain rejected. Qualification attaches to the exact accepted owner subject
